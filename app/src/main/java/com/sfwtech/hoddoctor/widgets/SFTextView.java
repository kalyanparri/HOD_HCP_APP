package com.sfwtech.hoddoctor.widgets;
...
import com.sfwtech.hoddoctor.R;
...
public class SFTextView extends AppCompatTextView {
     ...
     * @see #SFTextView(Context, AttributeSet, int)
     */
     ...
     * @see #SFTextView(Context, AttributeSet)
     */
    ...
    private void onInitTypeface(Context context, AttributeSet attrs, int defStyle) {
        ...
        int typefaceValue = 0;
        if (attrs != null) {
            TypedArray values = context.obtainStyledAttributes(attrs, R.styleable.SFTextView, defStyle, 0);
            typefaceValue = values.getInt(R.styleable.SFTextView_typeface, 0);
            values.recycle();
        }

        Typeface SFTypeface = SFTypefaceManager.obtaintTypeface(context, typefaceValue);
        setTypeface(SFTypeface);
    }
}